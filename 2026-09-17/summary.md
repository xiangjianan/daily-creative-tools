...
**验证：** 12 项规则测试通过；浏览器亲测示例、真实文件多选、移除、空输入、重复/重叠关键词、0B 和特殊文件名；桌面及 390/320px 布局，无控制台错误。复制后在浏览器内实际粘贴也通过；跨浏览器真机、原生拖放、跨应用粘贴仍未验证。完整证据见 [tests.md](tests.md)。
...
发布状态：GitHub Pages 部署成功，线上示例与真实文件核对均已亲测。
